...
public class GirlService {
    ...
    public void initData(int size) {
        ...
        for (int i = 0; i < size; i++) {
            Girl girl = new Girl();
            girl.setAge(random.nextInt(28));
            int nextInt = random.nextInt(surname.length);
            girl.setName(surname[nextInt] + nextInt);
            girl.setCupSize(String.valueOf((char) ('A' + random.nextInt(5))));
